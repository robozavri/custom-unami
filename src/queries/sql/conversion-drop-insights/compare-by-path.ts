...
export async function getPathComparisonData(
  websiteId: string,
...
async function relationalQuery(
  ...
  try {
    ...
    // Get previous period data by path
    // eslint-disable-next-line no-console
    ...
    // Build result array
    const result: PathComparisonData[] = [];
